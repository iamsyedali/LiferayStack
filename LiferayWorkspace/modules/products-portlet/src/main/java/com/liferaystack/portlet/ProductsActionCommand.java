...
@Component(
	immediate = true,
	property = {
        "javax.portlet.name=blade_portlet_ProductsPortlet",
        "mvc.command.name=products"
    },
    service = MVCActionCommand.class
)
public class ProductsActionCommand implements MVCActionCommand {
	@Override
