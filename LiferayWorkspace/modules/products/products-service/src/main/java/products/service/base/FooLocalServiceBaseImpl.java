...
import products.service.FooLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link products.service.impl.FooLocalServiceImpl}.
 * </p>
 *
...
public abstract class FooLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link products.service.FooLocalServiceUtil} to access the foo local service.
	 */
	...
	public Foo createFoo(long productId) {
		return fooPersistence.create(productId);
	}
	...
	public Foo deleteFoo(long productId) throws PortalException {
		return fooPersistence.remove(productId);
	}
	...
	public Foo fetchFoo(long productId) {
		return fooPersistence.fetchByPrimaryKey(productId);
	}
	...
	public Foo getFoo(long productId) throws PortalException {
		return fooPersistence.findByPrimaryKey(productId);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("products.model.Foo",
			fooLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister("products.model.Foo");
	}
