...
public interface ProductLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ProductLocalServiceUtil} to access the product local service. Add custom service methods to {@link products.service.impl.ProductLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Product> getProductsByUuidAndCompanyId(java.lang.String uuid,
		long companyId);
	...
	*/
	...
	public Product addProductMy(java.lang.String name,
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Product fetchProductByUuidAndGroupId(java.lang.String uuid,
		long groupId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Product getProductByUuidAndGroupId(java.lang.String uuid,
