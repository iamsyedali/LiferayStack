 ...
 * @see FooPersistence
 * @see products.service.persistence.impl.FooPersistenceImpl
 * @generated
 */
@ProviderType
public class FooUtil {
	...
	*/
	public static Foo findByUuid_First(java.lang.String uuid,
		...
		throws products.exception.NoSuchFooException {
	...
	*/
	public static Foo[] findByUuid_PrevAndNext(long productId,
	...
	* @throws NoSuchFooException if a foo with the primary key could not be found
	*/
	public static Foo[] findByUuid_C_PrevAndNext(long productId,
	...
	* @return the new foo
	*/
	public static Foo create(long productId) {
	...
	* @throws NoSuchFooException if a foo with the primary key could not be found
	*/
	public static Foo remove(long productId)
		throws products.exception.NoSuchFooException {
	...
	* @throws NoSuchFooException if a foo with the primary key could not be found
	*/
	public static Foo findByPrimaryKey(long productId)
		throws products.exception.NoSuchFooException {
	...
	*/
	public static Foo fetchByPrimaryKey(long productId) {
