...
package products.service.persistence;
 ...
 * @see products.service.persistence.impl.ProductPersistenceImpl
 * @generated
 */
@ProviderType
public class ProductUtil {
	...
	*/
	public static Product findByUuid_First(java.lang.String uuid,
		OrderByComparator<Product> orderByComparator)
		throws products.exception.NoSuchProductException {
	...
	* @return the matching products
	*/
	public static List<Product> findByStatus(int status) {
	...
	* @return the range of matching products
	*/
	public static List<Product> findByStatus(int status, int start, int end) {
	...
	* @throws NoSuchProductException if a matching product could not be found
	*/
	public static Product findByStatus_First(int status,
		OrderByComparator<Product> orderByComparator)
		throws products.exception.NoSuchProductException {
	...
	* @return the first matching product, or <code>null</code> if a matching product could not be found
	*/
	public static Product fetchByStatus_First(int status,
		OrderByComparator<Product> orderByComparator) {
	...
	* @throws NoSuchProductException if a matching product could not be found
	*/
	public static Product findByStatus_Last(int status,
		OrderByComparator<Product> orderByComparator)
		throws products.exception.NoSuchProductException {
	...
	* @return the last matching product, or <code>null</code> if a matching product could not be found
	*/
	public static Product fetchByStatus_Last(int status,
		OrderByComparator<Product> orderByComparator) {
	...
	* @throws NoSuchProductException if a product with the primary key could not be found
	*/
	public static Product[] findByStatus_PrevAndNext(long productId,
	...
	* @return the range of matching products
	*/
	public static List<Product> findByG_S(long groupId, int status, int start,
		int end) {
	...
	* @throws NoSuchProductException if a matching product could not be found
	*/
	public static Product findByG_S_First(long groupId, int status,
		OrderByComparator<Product> orderByComparator)
		throws products.exception.NoSuchProductException {
		return getPersistence()
	...
	* @return the first matching product, or <code>null</code> if a matching product could not be found
	*/
	public static Product fetchByG_S_First(long groupId, int status,
		OrderByComparator<Product> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchProductException if a matching product could not be found
	*/
	public static Product findByG_S_Last(long groupId, int status,
		OrderByComparator<Product> orderByComparator)
		throws products.exception.NoSuchProductException {
		return getPersistence()
	...
	* @return the last matching product, or <code>null</code> if a matching product could not be found
	*/
	public static Product fetchByG_S_Last(long groupId, int status,
		OrderByComparator<Product> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchProductException if a product with the primary key could not be found
	*/
	public static Product[] findByG_S_PrevAndNext(long productId, long groupId,
		int status, OrderByComparator<Product> orderByComparator)
		throws products.exception.NoSuchProductException {
		return getPersistence()
				   .findByG_S_PrevAndNext(productId, groupId, status,
			orderByComparator);
	}
