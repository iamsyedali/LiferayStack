...
import products.exception.NoSuchFooException;

import products.model.Foo;

import products.model.impl.FooImpl;
import products.model.impl.FooModelImpl;

import products.service.persistence.FooPersistence;
 ...
 * @see FooPersistence
 * @see products.service.persistence.FooUtil
 * @generated
 */
@ProviderType
public class FooPersistenceImpl extends BasePersistenceImpl<Foo>
	 ...
	 *
	 * @param productId the primary key of the current foo
	 * @param uuid the uuid
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public Foo[] findByUuid_PrevAndNext(long productId, String uuid,
		OrderByComparator<Foo> orderByComparator) throws NoSuchFooException {
		Foo foo = findByPrimaryKey(productId);
	 ...
	 */
	@Override
	public Foo[] findByUuid_C_PrevAndNext(long productId, String uuid,
	 ...
	 */
	@Override
	public Foo create(long productId) {
		Foo foo = new FooImpl();

		foo.setNew(true);
		foo.setPrimaryKey(productId);
	 ...
	 */
	@Override
	public Foo remove(long productId) throws NoSuchFooException {
	...
	protected Foo toUnwrappedModel(Foo foo) {
		...
		fooImpl.setProductId(foo.getProductId());
		fooImpl.setName(foo.getName());
		fooImpl.setDescription(foo.getDescription());
	 ...
	 */
	@Override
	public Foo findByPrimaryKey(long productId) throws NoSuchFooException {
	 ...
	 */
	@Override
	public Foo fetchByPrimaryKey(long productId) {
	...
	private static final String _SQL_SELECT_FOO_WHERE_PKS_IN = "SELECT foo FROM Foo foo WHERE productId IN (";
