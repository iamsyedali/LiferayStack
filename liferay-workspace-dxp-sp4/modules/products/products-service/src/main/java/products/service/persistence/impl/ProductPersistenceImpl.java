...
package products.service.persistence.impl;
...
import products.exception.NoSuchProductException;

import products.model.Product;

import products.model.impl.ProductImpl;
import products.model.impl.ProductModelImpl;

import products.service.persistence.ProductPersistence;
 ...
 * @see products.service.persistence.ProductUtil
 * @generated
 */
@ProviderType
public class ProductPersistenceImpl extends BasePersistenceImpl<Product>
	 ...
	 */
	@Override
	public Product[] findByStatus_PrevAndNext(long productId, int status,
		OrderByComparator<Product> orderByComparator)
		throws NoSuchProductException {
		Product product = findByPrimaryKey(productId);
	...
	private static final String _FINDER_COLUMN_STATUS_STATUS_2 = "product.status = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_G_S = new FinderPath(ProductModelImpl.ENTITY_CACHE_ENABLED,
			ProductModelImpl.FINDER_CACHE_ENABLED, ProductImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_S = new FinderPath(ProductModelImpl.ENTITY_CACHE_ENABLED,
			ProductModelImpl.FINDER_CACHE_ENABLED, ProductImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByG_S",
			new String[] { Long.class.getName(), Integer.class.getName() },
			ProductModelImpl.GROUPID_COLUMN_BITMASK |
			ProductModelImpl.STATUS_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_G_S = new FinderPath(ProductModelImpl.ENTITY_CACHE_ENABLED,
			ProductModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<Product> findByG_S(long groupId, int status, int start, int end) {
	 ...
	 */
	@Override
	public List<Product> findByG_S(long groupId, int status, int start,
		int end, OrderByComparator<Product> orderByComparator) {
	 ...
	 */
	@Override
	public Product findByG_S_First(long groupId, int status,
		OrderByComparator<Product> orderByComparator)
		throws NoSuchProductException {
	 ...
	 */
	@Override
	public Product fetchByG_S_First(long groupId, int status,
		OrderByComparator<Product> orderByComparator) {
		List<Product> list = findByG_S(groupId, status, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public Product findByG_S_Last(long groupId, int status,
		OrderByComparator<Product> orderByComparator)
		throws NoSuchProductException {
	 ...
	 */
	@Override
	public Product fetchByG_S_Last(long groupId, int status,
		OrderByComparator<Product> orderByComparator) {
		...
		List<Product> list = findByG_S(groupId, status, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public Product[] findByG_S_PrevAndNext(long productId, long groupId,
		int status, OrderByComparator<Product> orderByComparator)
		throws NoSuchProductException {
		Product product = findByPrimaryKey(productId);
		...
		try {
			...
			array[0] = getByG_S_PrevAndNext(session, product, groupId, status,
					orderByComparator, true);

			array[1] = product;

			array[2] = getByG_S_PrevAndNext(session, product, groupId, status,
					orderByComparator, false);
	...
	protected Product getByG_S_PrevAndNext(Session session, Product product,
	...
	public void removeByG_S(long groupId, int status) {
		for (Product product : findByG_S(groupId, status, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(product);
		}
	}
	...
	private static final String _FINDER_COLUMN_G_S_GROUPID_2 = "product.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_S_STATUS_2 = "product.status = ?";
	...
	public Product updateImpl(Product product) {
		...
		if (!ProductModelImpl.COLUMN_BITMASK_ENABLED) {
			finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);
		}
		else
		 if (isNew) {
